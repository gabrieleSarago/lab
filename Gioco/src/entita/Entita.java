...
/**
 * Crea l'oggetto Entitia',necessario per implementare nel gioco
...
public abstract class Entita implements Externalizable{
	...
	/**
	 * Costuttore dell'oggetto Entitia'
	 * @param h oggetto Handler per curare la gestione con le altre classi.
	 * @param x cordinata X dell'entit�.
	 * @param y cordianta Y dell'entit�.
	 * @param larghezza la larghezza dell'entit�
	 * @param altezza l'altezza dell'entit�
	 */
	...
	/**
	 * Metodo accessore che ritorna il bounds di collisione dell'entit�.
	 * @param xOffset l'offset sulle ascisse.
	 * @param yOffset l'offset sulle ordinate.
	 * @return oggetto Rectangle che rappresenta il bounds di collisione con l'entit�.
	 */
	...
	/**
	 * Metodo utile per salvare le posizioni delle entit� nel gioco.
	...
	/**
	 * Metodo utile per caricare le entitia' nelle loro posizioni.
	 * Riceve come parametro uno stream di tipo a oggetti.
	 */
