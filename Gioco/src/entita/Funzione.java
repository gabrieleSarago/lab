...
public class Funzione implements Externalizable{
	...
	/**
	 * 
	 * @param array_entita un ArrayList che contiene oggetti Entita'
	 * @param index parametro che identifica la posizione dell'oggetto Entita' nell'ArrayList.
	...
	public Funzione(ArrayList<Entita> array_entita, int index, Funzionalita funzione){
		...
		if(collegamento == null || funzione == null) 
	...
	/**
	 * Metodo per salvare le funzioni degli oggetti Entita'.
	 */
	...
	/**
	 * Metodo per caricare le entita' che implementano una data funzione.
	 */
