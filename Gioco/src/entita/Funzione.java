...
public class Funzione implements Externalizable{
	...
	/**
	 * 
	 * @param array_entita un ArrayList che contiene oggetti Entit�
	 * @param index parametro che identifica la posizione dell'oggetto Entit� nell'ArrayList.
	...
	/**
	 * Metodo per salvare le funzioni degli oggetti Entit�.
	 */
	...
	/**
	 * Metodo per caricare le entit� che implementano una data funzione.
	 */
