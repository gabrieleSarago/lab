...
public class CaricatoreImmagini {
	...
	public static BufferedImage caricaImmagine(String path){
		...
		try {
			/*Per convertire in jar bisogna creare una source folder, resource, che conterr� la cartella res
			privata della build path. Questo perch� la cartella res non viene esportata nel jar s viene intesa
			come source folder ma esporta solo le sue sottocartelle.
			Si aggiunge "/" al path poich� altrimenti la ricerca del file inizierebbe
